...
void CurrentTemperatureWatcher::UnregisterFromBus()
{
    ...
    {
        PCSTR interfaces[] = { "org.alljoyn.SmartSpaces.Environment.CurrentTemperature" };
    ...
    _In_ const alljoyn_msgarg aboutDataArg)
{
    ...
    if (alljoyn_aboutobjectdescription_hasinterface(objectDescription, "org.alljoyn.SmartSpaces.Environment.CurrentTemperature"))
    {
        AllJoynServiceInfo^ args = ref new AllJoynServiceInfo(
            AllJoynHelpers::MultibyteToPlatformString(name),
            AllJoynHelpers::GetObjectPath(objectDescription, "org.alljoyn.SmartSpaces.Environment.CurrentTemperature"),
            port);
        Added(this, args);
    }
